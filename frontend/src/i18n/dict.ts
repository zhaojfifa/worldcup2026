...
const ZH = {
  ...
  recapSectionTitle: '世界杯经典复盘 · 2022',
  recapSectionSub: '真实赛果回灌 · 模型校准样本 · 非当前比赛',
  recapBadge: '历史复盘',
  recapReportCta: '复盘报告',
  recapDetailNote: '历史复盘：这是一场已完赛比赛，用于观察 Giành Cup 情报官如何复盘变量与校准模型。不是当前赛前预测。',
  evidenceModeRecap: '历史数据 · 模型校准 · 非当前比赛',
  riskRadarTitle: '风险雷达',
  radarForm: '近期状态',
  radarSquad: '阵容完整度',
  radarTactical: '战术对位',
  ...
  evidencePackTitle: '详细模型报告状态',
  evidencePackStatusNote: '本场详细模型报告尚未生成。真实赛果已接入，可用于历史复盘；球员、教练、首发、伤停、媒体与市场变化等情报仍待接入或人工补充。',
  evidencePackHaveTitle: '已接入数据',
  evidencePackMissTitle: '待接入 / 缺失情报',
  evidencePackNextTitle: '下一步需要补充',
  evHaveFixture: '赛程（球队 / 开赛时间 / 状态）',
  evHaveResult: '真实赛果已结算（历史复盘用）',
  evHaveProb: '胜平负概率（AI 基线模型）',
  evHaveRecap: '历史复盘状态',
  evMissPlayers: '球员名单',
  evMissCoach: '教练信息',
  evMissLineup: '首发阵容',
  ...
  evMissMedia: '媒体 / 新闻信号',
  evMissOdds: '赔率 / 市场变化',
  evidencePackNextNote: '运营在 Render 同步真实赛程/赛果与情报字段后，本场将升级为完整模型报告。',
...
const VI: Partial<Copy> = {
  ...
  recapSectionSub: 'Kết quả thật · mẫu hiệu chỉnh mô hình · không phải trận hiện tại',
  recapBadge: 'Phục dựng lịch sử',
  recapReportCta: 'Xem phục dựng',
  recapDetailNote: 'Phục dựng lịch sử: Trận này đã kết thúc. Dùng để xem Giành Cup Scout đọc lại biến số và hiệu chỉnh mô hình. Không phải dự đoán trận hiện tại.',
  evidenceModeRecap: 'Dữ liệu lịch sử · hiệu chỉnh mô hình · không phải trận hiện tại',
  ...
  // ── Evidence Pack (recap / báo cáo chi tiết chưa tạo) ──
  evidencePackTitle: 'Trạng thái báo cáo mô hình chi tiết',
  evidencePackStatusNote: 'Báo cáo mô hình chi tiết cho trận này chưa được tạo. Kết quả thật đã được đưa vào để phục dựng lịch sử; dữ liệu cầu thủ, HLV, đội hình xuất phát, chấn thương, truyền thông và biến động thị trường vẫn cần được bổ sung.',
  evidencePackHaveTitle: 'Dữ liệu đã có',
  evidencePackMissTitle: 'Thông tin còn thiếu',
  evidencePackNextTitle: 'Cần bổ sung tiếp theo',
  evHaveFixture: 'Lịch thi đấu (đội / giờ / trạng thái)',
  evHaveResult: 'Kết quả thật đã kết toán (để phục dựng)',
  evHaveProb: 'Tỷ lệ thắng/hòa/thua (mô hình AI cơ sở)',
  evHaveRecap: 'Trạng thái phục dựng lịch sử',
  evMissPlayers: 'Danh sách cầu thủ',
  evMissCoach: 'Thông tin HLV',
  evMissLineup: 'Đội hình xuất phát',
  evMissInjury: 'Chấn thương / treo giò',
  evMissMedia: 'Tín hiệu truyền thông',
  evMissOdds: 'Tỷ lệ / biến động thị trường',
