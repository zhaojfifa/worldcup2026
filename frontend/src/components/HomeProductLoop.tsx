...
const L = {
  zh: {
    ...
    predWhy: '今日主推比赛：基于数据更新 + 大模型判断，开球前看方向，开球前 30 分钟修正。',
  ...
  vi: {
    ...
    predWhy: 'Trận chính hôm nay: dựa trên dữ liệu cập nhật + nhận định mô hình, xem hướng trước trận, hiệu chỉnh 30 phút trước giờ bóng lăn.',
