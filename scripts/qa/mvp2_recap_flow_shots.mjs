#!/usr/bin/env node
/**
 * MVP-2 Historical Recap product-flow QA screenshots (zero-dep CDP driver).
 ...
 *
 * Captures the customer product path for zh + vi:
 *   Home (with "Historical Recap · WC2022" entry)  ->  Recap detail (855737)
 *
 * Usage: node scripts/qa/mvp2_recap_flow_shots.mjs [BASE_URL]
 * Output: docs/qa_screenshots/mvp2_historical_recap_product_flow/
 */
