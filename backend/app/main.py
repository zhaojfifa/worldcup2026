...
from app.routers import health, matches, tokens, data_source, admin, performance, assets, social, rankings, llm, internal_scout_pack, recap, growth, daily_fixtures, runtime_content
...
app.include_router(daily_fixtures.router)
app.include_router(runtime_content.router)  # R4: runtime CONTENT source (no frontend deploy for daily content)
